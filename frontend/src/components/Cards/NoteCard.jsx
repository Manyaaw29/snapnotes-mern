    ...
    <div className="bg-white rounded-xl p-4 md:p-6 shadow-md hover:shadow-xl transition-all ease-in-out border-l-4 border-l-blue-500">
      ...
      <div className="flex items-center justify-between mt-4 md:mt-5">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <MdCreate
            className="text-base text-gray-600 hover:text-green-600 cursor-pointer transition"
            onClick={onEdit}
          />
          <MdDelete
            className="text-base text-gray-600 hover:text-red-600 cursor-pointer transition"
            onClick={onDelete}
          />
        </div>
      </div>
