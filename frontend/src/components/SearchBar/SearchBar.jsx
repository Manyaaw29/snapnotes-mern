...
const SearchBar = (props) => {
  ...
  return (
    <div className='w-full md:w-80 flex items-center px-3 md:px-4 bg-slate-100 rounded-md mt-0 md:mt-2'>
      ...
      {value && (
        <IoMdClose 
          className='text-slate-400 hover:text-black mr-2 md:mr-3 cursor-pointer text-sm transition flex-shrink-0' 
          onClick={onClearSearch}
        />
      )}
      <FaMagnifyingGlass 
        className='text-slate-500 text-sm cursor-pointer hover:text-black mr-2 md:mr-3 transition flex-shrink-0' 
