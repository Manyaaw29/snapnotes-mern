...
const onLogout = async () => {
  ...
  return (
    <div className="bg-gradient-to-r from-slate-800 via-blue-900 to-slate-800 shadow-xl border-b border-blue-800/30 transition-colors duration-300">
      ...
      {/* Mobile Menu */}
      {showMobileMenu && (
        <div className="md:hidden bg-slate-800 border-t border-blue-800/30 px-4 py-4 space-y-4">
          <SearchBar
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            handleSearch={handleSearch}
